...
extern void MPCStepFunction(double x[9], const double target[3], double dt,
                            double vx_max, double vy_max, double vz_max,
                            double ax_max, double ay_max, double az_max,
                            double wx, double wy, double wz, double wvx,
                            double wvy, double wvz, double wax, double way,
                            double waz, double wx_last, double wy_last,
